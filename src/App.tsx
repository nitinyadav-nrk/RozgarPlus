...
import AdminResumeBuilders from "@/pages/admin/ResumeBuilders";
...
function Router() {
  return (
    <Switch>
      ...
      <Route path="/resume-builder" component={() => <ProtectedRoute component={ResumeBuilder} />} />
      ...
      <Route path="/admin/resume-builders" component={() => <ProtectedRoute component={AdminResumeBuilders} adminOnly={true} />} />
